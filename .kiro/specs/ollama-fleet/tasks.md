...
- [ ] 2. Implement the configuration system
  ...
  - [-] 2.2 Write property test for config validation error completeness
...
- [ ] 3. Implement the database layer
  ...
  - [-] 3.3 Write property test for task state persistence round-trip
...
- [ ] 4. Implement the Ollama client
  - [-] 4.1 Implement `ollama_fleet/ollama/client.py` with async httpx streaming
...
- [ ] 5. Implement Pydantic agent output schemas
  - [ ] 5.1 Implement `ollama_fleet/agents/schemas.py` with all five agent output schemas
